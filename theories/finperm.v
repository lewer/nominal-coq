...
Lemma finperm_invP : left_inverse 1 (@finperm_inv K) (@finperm_mul K).
Proof.
move => π. apply/eq_finPermP => a.
by rewrite finsfunM /= finpermK finsfun1.
Qed.

Lemma finperm_oneP : left_id 1 (@finperm_mul K).
Proof. move => π. apply/eq_finPermP => a. by rewrite finsfunM /= finsfun1. Qed.

Lemma finperm_invVP : right_inverse 1 (@finperm_inv K) (@finperm_mul K).
